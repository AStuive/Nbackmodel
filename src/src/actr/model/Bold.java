...
public class Bold
{
	...
	static List<String> output = new ArrayList<String>(); //mlh
	private class Span
	{
		double startTime;
		boolean active;
	...
	void update ()  
	{	
		output.add(System.lineSeparator() + String.format("%.2f", model.getTime()) + " [ ");
		...
		while (it.hasNext())
		{
			...
			output.add(buffer.getString() + ":" + String.format("%2.3f ", cb) + " ");
		}
		output.add("]");
...
//				System.out.println ("]");
	...
	public boolean isImaging () { return brainImaging; }
