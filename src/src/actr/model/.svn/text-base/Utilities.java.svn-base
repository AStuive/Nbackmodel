...
public class Utilities
{
	...
	static long getUniqueID () { return (++currentID); }
	
	/**
	 * Gets a noise value sampled from the standard ACT-R noise distribution. The normal approximation
	 * used here is derived from the canonical ACT-R code.
	 * @param s the s value of the normal distribution
	 ...
	 */
	public static double rad2deg (double radians) { return radians * (180.0 / Math.PI); }
	 ...
	 * @param angle the visual angle in degrees
