...
public class U4AlphaArithmetic extends Task
{
	...
	private final String trialTuples[][] = {
			{"A", "2", "C", "K"}, {"D", "2", "F", "K"}, {"B", "3", "E", "K"},
			{"E", "3", "H", "K"}, {"C", "4", "G", "K"}, {"F", "4", "J", "K"},
			{"A", "2", "D", "D"}, {"D", "2", "G", "D"}, {"B", "3", "F", "D"},
			{"E", "3", "I", "D"}, {"C", "4", "H", "D"}, {"F", "4", "K", "D"},
			{"A", "2", "C", "K"}, {"D", "2", "F", "K"}, {"B", "3", "E", "K"},
			{"E", "3", "H", "K"}, {"C", "4", "G", "K"}, {"F", "4", "J", "K"},
			{"A", "2", "D", "D"}, {"D", "2", "G", "D"}, {"B", "3", "F", "D"},
			{"E", "3", "I", "D"}, {"C", "4", "H", "D"}, {"F", "4", "K", "D"}
	...
	private void printTable (double results[][])
	{
		...
		{
			String s = "Block " + (b+1);
			for (int j=0 ; j<3 ; j++) s += "\t" + String.format("%.3f", results[b][j]);
			getModel().output (s);
		}
	}
